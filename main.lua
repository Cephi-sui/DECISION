...
function love.update(dt)
  ...
  if player.x == (love.graphics.getWidth() - character.img:getWidth() - player.img:getWidth() - 30) and love.keyboard.isDown('space') and area.img == areaPortals then
    characterDialogue = 1
  end
...
function love.draw()
  ...
  if characterDialogue == 1 then
    love.graphics.print('Hello!', (love.graphics.getWidth() - character.img:getWidth() - 30), (love.graphics.getHeight() - character.img:getHeight() - 40))
  end
